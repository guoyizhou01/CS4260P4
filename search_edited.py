...
# convert numbers of location has the theme to 0 to 10 scale
...
# calculate time to be spent at each location
...
# calculate distance in stright line
...
def route_search(startLoc, locations, edges, days, drivingHour, x_mph, preferences, resultFile):
    ...
    #                                             list of hours by day, miles driven by day, list of visited locations)
    ...
    while len(frontier) > 0:
        ...
        if curr_loc == startLoc and len(curr_visit[0]) > 1:
            ...
            # track time cost and theme visited as we go
            totalTimeCost = 0
            totalThemes = 0
        ...
        # push each possible next location to the heap
